...
`;
  ...
  // src/iaux-bookmarks/ia-bookmarks-edit.js
  var IABookmarkEdit = class extends LitElement {
    static get styles() {
      return ia_bookmarks_edit_default;
    }
    static get properties() {
      return {
  ...
  var IAIconEditPencil = class extends LitElement {
    static get styles() {
      return css`
      :host {
        width: var(--iconWidth, 'auto');
    ...
    render() {
      return icon_edit_pencil_default;
    }
  };
