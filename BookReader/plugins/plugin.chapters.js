...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/js/plugins/plugin.chapters.js");
/******/ })
/************************************************************************/
/******/ ({
...
}(BookReader.prototype.setup); // Extend br.init to call Open Library for TOC
...
BookReader.prototype.addChapter = function (chapterTitle, pageNumber, pageIndex) {
  ...
  var jumpToChapter = function jumpToChapter(event) {
    return _this.jumpToIndex($(event.target).data('pageIndex'));
  };

  var title = "Chapter: ".concat(chapterTitle, " | ").concat(uiStringPage, " ").concat(pageNumber);
  $("<div><div>".concat(title, "</div></div>")).addClass('BRchapter').css({
    left: percentThrough
    ...
    _this.$('.BRsearch,.BRchapter').removeClass('front');

    $(_this).addClass('front');
  }, function () {
    return $(_this).removeClass('front');
...
BookReader.prototype.addChapterFromEntry = function (tocEntryObject) {
  var pageIndex = this.getPageIndex(tocEntryObject['pagenum']); // Only add if we know where it is
  ...
  */
  ...
  var setUpChapterMarkers = function setUpChapterMarkers(olObject) {
    if (olObject && olObject.table_of_contents) {
      ...
      _this2.updateTOC(olObject.table_of_contents);
    }
  };
  ...
  $.ajax({
    ...
    success: function success(data) {
      if (data && data.length > 0) {
        ...
        // try sourceid
        var fetchURLBySourceId = "".concat(baseURL, "&source_records=ia:").concat(_this2.bookId);
        $.ajax({
