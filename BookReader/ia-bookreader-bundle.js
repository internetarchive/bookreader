...
`;class jo extends o.oi{static get styles(){return o.iv`
    ...
    `}render(){return Ao}}customElements.define("ia-icon-magnify-minus",jo);var Mo,zo,Io,Lo,Po,To,Do,Ro=a.dy`
<svg
  viewBox="0 0 18 18"
  xmlns="http://www.w3.org/2000/svg"
...
`;class zi extends o.oi{static get styles(){return o.iv`
      :host {
        width: var(--iconWidth, 'auto');
        height: var(--iconHeight, 'auto');
      }
