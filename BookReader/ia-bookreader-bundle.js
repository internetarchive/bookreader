...
`;customElements.define("ia-icon-ellipses",class extends ze{static get styles(){return N`
    ...
    `}}window.customElements.define("ia-activity-indicator",Mt);var zt=a.dy`
  <svg
    viewBox="0 0 40 40"
    version="1.1"
    xmlns="http://www.w3.org/2000/svg"
...
`;class jo extends o.oi{static get styles(){return o.iv`
    ...
    `}render(){return _o}}customElements.define("ia-icon-magnify-minus",jo);var Io,Mo,zo,Lo,Po,To,Do,Ro=a.dy`
<svg
  viewBox="0 0 18 18"
  xmlns="http://www.w3.org/2000/svg"
...
`;class Mi extends o.oi{static get styles(){return o.iv`
      :host {
        width: var(--iconWidth, 'auto');
        height: var(--iconHeight, 'auto');
      }
