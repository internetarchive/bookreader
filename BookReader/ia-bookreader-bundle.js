...
`;class Bn extends r.WF{static get styles(){return r.AH`
    ...
    `}render(){return jn}}customElements.define("ia-icon-magnify-minus",Bn);var Ln,En,Pn,Mn,An,In,zn,Tn=r.qy`
<svg
  viewBox="0 0 100 100"
  xmlns="http://www.w3.org/2000/svg"
...
`;class Io extends r.WF{static get styles(){return r.AH`
      :host {
        width: var(--iconWidth, 'auto');
        height: var(--iconHeight, 'auto');
      }
