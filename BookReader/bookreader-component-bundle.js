...
`;let rt=class extends se{constructor(){super(...arguments),this.config=new Ke}render(){return F`
    ...
    `}constructor(){super(),this.icon=""}render(){return Qe[this.icon]||F``}}),customElements.define("ia-menu-slider",class extends se{static get styles(){return de}static get properties(){return{menus:{type:Array},open:{type:Boolean},selectedMenu:{type:String},animateMenuOpen:{type:Boolean},manuallyHandleClose:{type:Boolean}}}constructor(){super(),this.menus=[],this.open=!1,this.selectedMenu="",this.animateMenuOpen=!1,this.manuallyHandleClose=!1}setSelectedMenu({detail:e}){const{id:t}=e;this.selectedMenu=this.selectedMenu===t?"":t}closeMenu(){this.manuallyHandleClose||(this.open=!1);const{closeDrawer:e}=fe,t=new CustomEvent(e,{detail:this.selectedMenuDetails});this.dispatchEvent(t)}get selectedMenuDetails(){return this.menus.find((e=>e.id===this.selectedMenu))}get selectedMenuComponent(){const e=this.selectedMenuDetails;return e&&e.component?e.component:F``}get sliderDetailsClass(){return`${this.animateMenuOpen?"animate":""} ${this.open?"open":""}`}get selectedMenuClass(){return this.selectedMenu?"open":""}get menuItems(){return this.menus.map((e=>F`
        <li>
          <menu-button
...
`;customElements.define("ia-icon-email",class extends se{static get styles(){return ie`
    ...
    `}render(){return Ve}});var vi=class extends di{constructor(e){super(e),this.name="Twitter",this.icon=F`<ia-icon-twitter></ia-icon-twitter>`,this.class="twitter"}get url(){return`https://twitter.com/intent/tweet?url=https://${this.baseHost}/details/${this.identifier}&via=internetarchive&text=${this.encodedDescription}+%3A+${this.encodedCreator}${this.encodedPromoCopy}`}};const gi=({currentTarget:e})=>{const t=e.querySelector("textarea"),n=e.querySelector("small");t.select(),document.execCommand("copy"),t.blur(),n.classList.add("visible"),clearTimeout(n.timeout),n.timeout=setTimeout((()=>n.classList.remove("visible")),4e3)};var bi,yi;function ki(e,t){return t||(t=e.slice(0)),Object.freeze(Object.defineProperties(e,{raw:{value:Object.freeze(t)}}))}function wi(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function Ci(e,t){for(var n=0;n<t.length;n++){var o=t[n];o.enumerable=o.enumerable||!1,o.configurable=!0,"value"in o&&(o.writable=!0),Object.defineProperty(e,o.key,o)}}customElements.define("ia-sharing-options",class extends se{static get styles(){return ui}static get properties(){return{baseHost:{type:String},creator:{type:String},description:{type:String},embedOptionsVisible:{type:Boolean},identifier:{type:String},sharingOptions:{type:Array},type:{type:String},renderHeader:{type:Boolean}}}constructor(){super(),this.baseHost="",this.sharingOptions=[]}firstUpdated(){const{baseHost:e,creator:t,description:n,identifier:o,type:r}=this,i={baseHost:e,creator:t,description:n,identifier:o,type:r};this.sharingOptions=[new vi(i),new pi(i),new mi(i),new fi(i),new hi(i)]}get sharingItems(){return this.sharingOptions.map((e=>F`<li>
      ...
      <ul>
        ${this.sharingItems}
        ${this.embedOption}
        <div class=${ci({visible:this.embedOptionsVisible,embed:!0})}>
          <h4>Embed</h4>
          <div class="code" @click=${gi}>
