...
The project uses [ESLint](https://eslint.org/), and the rules can be found
within the [.eslintrc.cjs](./.eslintrc.cjs) file.

To run the linter, run command: `npm run lint`.
