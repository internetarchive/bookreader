...
**Disclaimer: BookReader v5 is currently in beta. It's stable enough for production use (and is what is being used on archive.org), but there will be breaking changes until we stabilize the public BookReader APIs.**
