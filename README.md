...
**Disclaimer: BookReader v5 is currently in beta. It is stable enough for production use and is actively deployed on archive.org. However, future updates may introduce breaking changes to public BookReader APIs.**
